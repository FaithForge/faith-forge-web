...
/**
 * Vista para Crear un Nuevo Usuario en el Panel de Administración.
 * Soporta creación de datos de persona (POST /user) y opcionalmente cuenta de acceso (POST /user/account).
 */
const CreateUserView: React.FC = () => {
  ...
  // Estado para la pantalla de confirmación tras crear cuenta
  ...
  // Auto-completar password con el teléfono si no ha sido editado manualmente
  useEffect(() => {
  ...
  /**
   * Envía el formulario para crear el usuario y opcionalmente su cuenta de acceso.
   *
  ...
  const onSubmit = async (data: CreateUserFormData) => {
    ...
    try {
      ...
      // 3. Crear cuenta de acceso si está activada (POST /user/account)
      if (data.createAccount) {
        if (!createdUserId) {
          ...
          try {
            ...
            // Mostrar pantalla de confirmación con credenciales y compartir WhatsApp
...
⚠️ *Importante:* Guarda estas credenciales en un lugar seguro y te recomendamos borrar este mensaje por seguridad una vez hayas iniciado sesión.`;
  ...
  // =========================================================================
  // VISTA 1: Formulario Principal de Creación de Usuario
  // =========================================================================
  return (
    <div className="min-h-full bg-slate-50/60 pb-20">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
          ...
          <div className={clsx(
            ...
            <div className="p-5 sm:p-6 flex flex-col gap-4">
              ...
              {/* Checkbox Header con Validación Previa */}
              <div 
              ...
              {/* Contenido desplegable si está marcado */}
              {watchedCreateAccount && (
