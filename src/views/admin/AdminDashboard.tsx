...
const ADMIN_CATEGORIES: AdminCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Busca, edita información personal y gestiona datos de usuarios existentes.',
        icon: UserCog,
      ...
      },
      {
        ...
        description: 'Administra los roles activos y permisos de acceso asignados a cada usuario.',
        icon: ShieldCheck,
