              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        <h4 className="text-base font-black text-slate-900 break-words leading-tight">
                          {kidFullName}
                        </h4>
                        {/* Status Badge */}
                        <div className="shrink-0 mt-0.5">
                          {isCheckedInToday ? (
                            kid.todayRegistration?.isMeetingFinished ? (
                              <span className="inline-flex items-center gap-1.5 text-xs font-bold bg-slate-100 text-slate-800 border border-slate-300 px-2.5 py-0.5 rounded-full shadow-2xs">
                      ...
                      {/* Parentesco y Edad */}
                      <div className="flex items-center gap-2 text-xs sm:text-sm text-slate-700 font-semibold mt-1">
                        {kid.relation && (
                      ...
                      {kid.birthday && (
                        <div className="flex items-center gap-1.5 text-xs sm:text-sm text-slate-700 mt-1">
                  ...
                  {isCheckedInToday && kid.todayRegistration ? (
                    <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-3 sm:p-3.5 flex flex-col gap-2.5">
                      {/* Header */}
                      <div className="flex items-center justify-between text-xs pb-1.5 border-b border-slate-200">
                        ...
                        {kid.todayRegistration.date && (
                          <span className="text-xs font-bold text-slate-900 bg-white border border-slate-200 px-2 py-0.5 rounded-md shadow-2xs">
                      ...
                      {/* 2-Column Grid con tipografía clara y cómoda */}
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                        ...
                        <div className="min-w-0">
                          ...
                          <span className="text-sm font-bold text-slate-900 block truncate leading-snug">
